...
<html lang="en">
<head>
    <title>Code coverage report for monolog\lib\monolog.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">monolog\lib\monolog.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">monolog\lib\</a> &#187; monolog.js</div>
</div>
<div class="body">
...
monolog.create = function() {
  return (function(func, args, ctor) {
    ...
    return Object(result) === result ? <span class="branch-0 cbranch-no" title="branch not covered" >result </span>: child;
